...
#define _LAST_ERR   ERR_BAYER_INVALID_BLUE_GAIN
...
typedef enum LearnSetupOption_enum {
    // Old PM options
    IMAQ_LDLO_SearchStrategy            =   0,
    IMAQ_LDLO_InitialStepSize           =   1,
    IMAQ_LDLO_InitialSampleSize         =   2,
    IMAQ_LDLO_InitialSampleSizeFactor   =   3,
    IMAQ_LDLO_InitialAngularAccuracy    =   4,
    IMAQ_LDLO_FinalSampleSize           =   5,
    IMAQ_LDLO_FinalSampleSizeFactor     =   6,
    IMAQ_LDLO_FinalAngularAccuracy      =   7,
    IMAQ_LDLO_SubpixelSampleSize        =   8,
    IMAQ_LDLO_SubpixelSampleSizeFactor  =   9,
	IMAQ_LDLO_MatchOffsetXPosition      =   10,
	IMAQ_LDLO_MatchOffsetYPosition      =   11,
	IMAQ_LDLO_MatchOffsetAngle          =   12,
    // New PM options
	IMAQ_PYLO_SubpixelSampleSize        =   100,
	IMAQ_PYLO_SubpixelSampleSizeFactor  =   101,
	IMAQ_PYLO_MatchOffsetXPosition      =   102,
	IMAQ_PYLO_MatchOffsetYPosition      =   103,
	IMAQ_PYLO_MatchOffsetAngle          =   104,
    IMAQ_PYLO_MaxPyramidLevelToStoreData=   105,
    IMAQ_COMBINEDLEARNSETUPOPTION_SIZE_GUARD =	0xFFFFFFFF
} LearnSetupOption;

typedef enum MatchSetupOption_enum {
    IMAQ_LDMO_MinimumContrast               =   0,
    IMAQ_LDMO_EnableSubpixelAccuracy        =   1,
    IMAQ_LDMO_SearchStrategy                =   2,
    IMAQ_LDMO_SubpixelIterations            =   3,
    IMAQ_LDMO_SubpixelTolerance             =   4,
    IMAQ_LDMO_InitialMatchListLength        =   5,
    IMAQ_LDMO_MatchListReductionFactor      =   6,
    IMAQ_LDMO_InitialStepSize               =   7,
    IMAQ_LDMO_IntermediateAngularAccuracy   =   8,
    // Pyramid Matching Options
	IMAQ_PYMO_MaxPyramidLevel               =   100,
	IMAQ_PYMO_EnableSpiralSearch            =   101,
    IMAQ_PYMO_MinimumContrast               =   102,
	IMAQ_PYMO_EnableSubpixelAccuracy        =   103,
	IMAQ_PYMO_SubpixelIterations            =   104,
	IMAQ_PYMO_SubpixelTolerance             =   105,
	IMAQ_PYMO_InitialMatchListLength        =   106,
	IMAQ_PYMO_MatchListReductionFactor      =   107,
	IMAQ_PYMO_IntermediateAngularAccuracy   =   108,
	IMAQ_PYMO_ProcessBorderMatches          =   109,
	IMAQ_PYMO_FastMatchMode                 =   110,
    IMAQ_PYMO_MinMatchSeparationDistance    =   111,
    IMAQ_PYMO_MinMatchSeparationAngle       =   112,
    IMAQ_PYMO_MaxMatchOverlap               =   113,
    IMAQ_PYMO_MaxCacheSizeInMegabytes       =   114,
    IMAQ_PYMO_ClearCacheOnEveryMatch        =   115,
